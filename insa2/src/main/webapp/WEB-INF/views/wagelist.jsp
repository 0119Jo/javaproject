				...
				<div class="card-header">
					<ul class="nav nav-tabs card-header-tabs pull-right" role="tablist">
						<li class="nav-item"><a class="nav-link active"
							data-toggle="tab" href="#tab-1">전체 지급현황</a></li>
						<li class="nav-item"><a class="nav-link active"
							data-toggle="tab" href="#tab-2">부서별 지급현황</a></li>
						<li class="nav-item"><a class="nav-link" data-toggle="tab"
							href="#tab-3">사원별 지급현황</a></li>
					</ul>
				</div>
				<div class="card-body">
										...
										<table class="table mb-0 table-bordered"
											...
											<tbody>
												...
												<c:forEach var="p" items="${alllist }">
													<tr>
														<td>${p.wage_statement_emp_no }</td>
														<td>${p.wage_statement_emp_name }</td>
														<td>${p.wage_statement_dept_name }</td>
														<td>${p.wage_statement_mon }</td>
														<td>${p.wage_statement_sal }</td>
														<td>${p.wage_statement_jikpay }</td>
														<td>${p.wage_statement_overpay }</td>
														<td>${p.wage_statement_specialpay }</td>
														<td>${p.wage_statement_etcpay }</td>
														<td>${p.wage_statement_bonus }</td>
														<td>${p.wage_statement_taxtarget }</td>
														<td>${p.wage_statement_meal }</td>
														<td>${p.wage_statement_drive }</td>
														<td>${p.wage_statement_psum }</td>
														<td>${p.wage_statement_nation }</td>
														<td>${p.wage_statement_helin }</td>
														<td>${p.wage_statement_carein }</td>
														<td>${p.wage_statement_empin }</td>
														<td>${p.wage_statement_intax }</td>
														<td>${p.wage_statement_lotax }</td>
														<td>${p.wage_statement_beforedel }</td>
														<td>${p.wage_statement_yearendtax }</td>
														<td>${p.wage_statement_dsum }</td>
														<td>${p.wage_statement_salary }</td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
									...
									<div class="table-responsive">
										<table class="table mb-0 table-bordered"
											...
											<tbody>
												...
												<c:forEach var="p" items="${listbybuser }">
													<tr>
														<td>${p.wage_statement_emp_no }</td>
														<td>${p.wage_statement_emp_name }</td>
														<td>${p.wage_statement_dept_name }</td>
